---
title: Minco 1.1.0
description: Stable documentation for Minco 1.1.0 contract-to-cloud and agent-native application development.
---
...
<p class="doc-lead">Minco 1.1.0 is the frozen stable manual for building low-idle-cost Rust applications with reviewed OpenAPI boundaries, explicit runtime composition, inspectable AWS plans, and verifiable releases. It is published from immutable <a href="https://github.com/xicv/minco/releases/tag/v1.1.0"><code>v1.1.0</code></a>; the <a href="../1.0.0/">1.0.0 manual</a> remains available for applications that have not upgraded.</p>
