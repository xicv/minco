...
published baseline is 1.5.0. Minco 1.5.0 requires Rust 1.97.1. Use exact 1.5.0
packages for applications and the repository-pinned workspace binary when
contributing to later unreleased work.
...
The last command should print `minco 1.5.0`. Contributors use the
repository-pinned toolchain and workspace binary:
