...
published baseline is 1.4.0. Minco 1.4.0 and the 1.5.0 candidate require
Rust 1.97.1. Use exact 1.4.0 packages for applications and the
...
The last command should print `minco 1.4.0`. Contributors reviewing the 1.5.0
candidate use the repository-pinned toolchain and workspace binary:
...
cargo add minco@1.4.0 --features sqlx-sqlite,test
