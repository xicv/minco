...
published baseline is 1.2.2. Minco 1.2.2 and the 1.3.0 candidate require Rust
1.97.1. Use exact 1.2.2 packages for applications and the repository-pinned
workspace binary only when deliberately evaluating the unpublished candidate.
...
The last command should print `minco 1.2.2`. Contributors reviewing the 1.3.0
