...
This is the frozen candidate manual for the unpublished Minco 1.2.0 source: a
contract-to-cloud Rust framework for low-idle-cost web applications on AWS.
It does not create a tag, release, registry publication or deployment, and it
never changes the meaning of the [stable 1.1.0 documentation](/1.1.0/).
