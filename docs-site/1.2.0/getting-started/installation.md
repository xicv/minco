...
published baseline is 1.2.0 and requires Rust 1.97.1. Use exact 1.2.0 packages
for applications; use a repository-pinned workspace binary only when
deliberately evaluating later unreleased source.
