...
published baseline is 1.3.0. Minco 1.3.0 and the 1.4.0 candidate require Rust
1.97.1. Use exact 1.3.0 packages for applications and the repository-pinned
workspace binary only when deliberately evaluating this unpublished candidate.
...
The last command should print `minco 1.3.0`. Contributors reviewing the 1.4.0
