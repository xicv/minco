...
published baseline is 1.2.0 and the unpublished workspace candidate is 1.2.1;
both require Rust 1.97.1. Use exact 1.2.0 packages for applications until
1.2.1 publication is independently confirmed. Use a repository-pinned
...
The last command should print `minco 1.2.0`. Contributors reviewing unreleased
...
The candidate remains unavailable from crates.io. After exact 1.2.1
...
Until then, use the published 1.2.0 commands below or an explicitly reviewed
...
cargo add minco@1.2.0 --features sqlx-sqlite,test
