...
```toml
[dependencies]
minco = { version = "1.7.0", features = ["plugin-payments-waffo"] }
minco-plugin-payments-waffo = "1.7.0"
```

Use the exact published 1.7.0 versions shown above. The feature also enables Minco's
