...
```toml
[dependencies]
minco = { version = "1.8.0", features = ["plugin-payments-waffo"] }
minco-plugin-payments-waffo = "1.8.0"
```

Use the exact published 1.8.0 versions shown above. The feature also enables Minco's
