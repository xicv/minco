...
published baseline is 1.8.0. The release and current development require Rust
1.97.1. Use exact 1.8.0 packages for applications and the repository-pinned
