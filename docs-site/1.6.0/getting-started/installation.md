...
published baseline is 1.6.0. Minco 1.6.0 requires Rust 1.97.1. Use exact 1.6.0
packages for applications and the
...
The last command should print `minco 1.6.0`. Contributors use the
