...
hero:
  ...
  actions:
    - theme: brand
      text: Read the 1.10.0 docs
      link: /1.10.0/
    - theme: alt
      text: Explore the production blueprint
      link: /1.10.0/cookbook/production-blueprint
...
<section class="home-section home-scenario-panel" aria-labelledby="scenario-title">
  <div class="home-scenario-copy">
    ...
    <a class="home-text-link" href="./1.10.0/cookbook/production-blueprint">Read the production blueprint</a>
  </div>
...
<section class="home-section home-zero-idle" aria-labelledby="zero-idle-title">
  ...
  <div class="home-zero-copy">
    ...
    <div class="home-zero-links">
      <a href="./1.10.0/explanation/zero-idle">Understand zero idle</a>
      <a href="./1.10.0/guides/deployment">Review deployment guards</a>
      <a href="./1.10.0/reference/testing">See the evidence model</a>
    </div>
  </div>
</section>
...
<section class="home-section home-cta" aria-labelledby="start-title">
  ...
  <div class="home-cta-actions">
    <a href="./1.10.0/getting-started/first-application">Build the first application</a>
    <a href="./1.10.0/features/">Browse the feature map</a>
  </div>
</section>
