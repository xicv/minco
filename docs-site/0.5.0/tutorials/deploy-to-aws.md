---
title: Deploy to AWS
description: Move one exact Minco 0.5.0 artifact through plan, review, apply, verify, and promotion.
minco_version: 0.5.0
rust_version: 1.97.1
---
...
[deployment lifecycle reference](https://github.com/xicv/minco/blob/v0.5.0/docs/deployment/dev-to-deploy.md).
