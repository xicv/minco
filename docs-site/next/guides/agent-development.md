...
Minco 1.1 packages the same focused application workflows for Codex and Claude
Code. The skills select Minco commands and source authorities; they do not add a
hosted agent runtime or replace the application graph.
