...
<p class="doc-lead">This manual describes the source on <code>main</code>. It develops the same contract-to-cloud model as the frozen <a href="../1.2.0/">1.2.0 manual</a>, while making unreleased behavior visibly separate from stable guidance.</p>
