...
published baseline is 1.2.0. Minco 1.2.0 and current development require Rust
1.97.1. Use exact 1.2.0 packages for applications and the repository-pinned
