...
published baseline is 1.5.0. Minco 1.5.0 and current development require Rust
1.97.1. Use exact 1.5.0 packages for applications and the
...
The last command should print `minco 1.5.0`. Contributors reviewing unreleased
