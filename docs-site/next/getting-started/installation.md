...
published baseline is 1.4.0. Minco 1.4.0 and current development require Rust
1.97.1. Use exact 1.4.0 packages for applications and the repository-pinned
