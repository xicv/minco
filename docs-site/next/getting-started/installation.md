...
latest published release is 1.0.0 and requires Rust 1.97.1. Use the exact
source checkout only when testing changes documented by this unreleased manual.
...
cargo add minco@1.0.0 --features sqlx-sqlite,test
