...
published baseline is 1.4.0. Minco 1.4.0 and the current 1.5.0 candidate require
...
The last command should print `minco 1.4.0`. Contributors reviewing unreleased
