...
published 0.6.0 line requires Rust 1.97.1.
...
The last command should print `minco 0.6.0`. Contributors working from `main`
use the repository-pinned toolchain and workspace binary:
