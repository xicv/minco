...
- [Build your first API](https://xicv.github.io/minco/1.2.1/getting-started/first-application)
- [Build a resource API](https://xicv.github.io/minco/1.2.1/guides/resource-api)
- [Deploy to AWS](https://xicv.github.io/minco/1.2.1/guides/deployment)
- [CLI reference](https://xicv.github.io/minco/1.2.1/reference/cli)
- [Generated package, feature, plugin, CLI, schema, and diagnostic reference](docs/reference/generated/index.md)
- [Plugin conformance](https://xicv.github.io/minco/1.2.1/guides/plugin-conformance)
- [Zero idle, precisely](https://xicv.github.io/minco/1.2.1/explanation/zero-idle)
- [Develop with Codex and Claude](https://xicv.github.io/minco/1.2.1/guides/agent-development)
...
the [agent development guide](https://xicv.github.io/minco/1.2.1/guides/agent-development).
...
Minco 1.2.1 retains the opt-in, OpenAPI-first CRUD convention without adding
...
The published `1.2.1` release includes strict, archive-visible plugin distribution
...
[`1.2.1` plugin guide](https://xicv.github.io/minco/1.2.1/guides/plugin-conformance).
...
The coordinated 33-crate `1.2.1` family is published from immutable tag
[`v1.2.1`](https://github.com/xicv/minco/releases/tag/v1.2.1) at exact qualified
commit `5f329ebbabef2840b01f10743f8dbb25a0b0dbe4`. Independent registry validation
