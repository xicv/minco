...
mod tests {
    ...
    fn accepts_only_provider_short_id_shape() {
        assert!(validate_short_id("MER_0123456789ABCDEFGHIJKL", "MER").is_ok());
        assert!(validate_short_id("STO_0123456789ABCDEFGHIJKL", "STO").is_ok());
        assert!(validate_short_id("PROD_0123456789ABCDEFGHIJKL", "PROD").is_ok());
        assert!(validate_short_id("PROD_ABC123", "PROD").is_err());
        assert!(validate_short_id("PROD__0123456789ABCDEFGHIJK", "PROD").is_err());
        assert!(validate_short_id("STO_0123456789ABCDEFGHIJK!", "STO").is_err());
        assert!(validate_short_id("MER-0123456789ABCDEFGHIJKL", "MER").is_err());
        assert!(validate_short_id("MER_0123456789ABCDEFGHIJKLM", "MER").is_err());
    }
}
