...
[1.3.0-to-1.4.0 guide](../adoption/1.3.0-to-1.4.0.md) when changing a
consumer's exact package set from the prior minor.
...
Pin the published `1.4.0` line in production applications, then follow
