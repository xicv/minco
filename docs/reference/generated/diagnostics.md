...
| `STATIC-ARCH-001` | repository truth | `scripts/validate_static.py:917` | 0 |
| `STATIC-ARCH-002` | repository truth | `scripts/validate_static.py:923` | 0 |
| `STATIC-ARCH-003` | repository truth | `scripts/validate_static.py:929` | 0 |
| `STATIC-ARCH-004` | repository truth | `scripts/validate_static.py:932` | 0 |
...
| `STATIC-BUDGET-004` | repository truth | `scripts/test/repository_truth.py:379` | 1 |
| `STATIC-BUDGET-005` | repository truth | `scripts/validate_static.py:386` | 0 |
| `STATIC-BUDGET-006` | repository truth | `scripts/test/repository_truth.py:402` | 1 |
| `STATIC-BUDGET-007` | repository truth | `scripts/test/repository_truth.py:419` | 1 |
...
| `STATIC-CONTRACT-001` | repository truth | `scripts/validate_static.py:760` | 0 |
| `STATIC-CONTRACT-002` | repository truth | `scripts/validate_static.py:765` | 0 |
| `STATIC-CONTRACT-003` | repository truth | `scripts/validate_static.py:773` | 0 |
| `STATIC-CONTRACT-004` | repository truth | `scripts/validate_static.py:776` | 0 |
| `STATIC-CONTRACT-005` | repository truth | `scripts/validate_static.py:780` | 0 |
| `STATIC-CONTRACT-006` | repository truth | `scripts/validate_static.py:782` | 0 |
| `STATIC-CONTRACT-007` | repository truth | `scripts/validate_static.py:821` | 0 |
| `STATIC-CONTRACT-008` | repository truth | `scripts/validate_static.py:870` | 0 |
| `STATIC-CONTRACT-009` | repository truth | `scripts/validate_static.py:878` | 0 |
| `STATIC-CONTRACT-010` | repository truth | `scripts/validate_static.py:883` | 0 |
| `STATIC-CONTRACT-011` | repository truth | `scripts/validate_static.py:887` | 0 |
| `STATIC-CONTRACT-012` | repository truth | `scripts/validate_static.py:893` | 0 |
| `STATIC-CONTRACT-013` | repository truth | `scripts/validate_static.py:898` | 0 |
| `STATIC-CONTRACT-014` | repository truth | `scripts/validate_static.py:796` | 0 |
| `STATIC-CONTRACT-015` | repository truth | `scripts/validate_static.py:824` | 0 |
| `STATIC-CONTRACT-016` | repository truth | `scripts/validate_static.py:839` | 0 |
| `STATIC-CONTRACT-017` | repository truth | `scripts/validate_static.py:789` | 0 |
| `STATIC-CONTRACT-019` | repository truth | `scripts/validate_static.py:857` | 0 |
| `STATIC-CONTRACT-020` | repository truth | `scripts/validate_static.py:832` | 0 |
| `STATIC-CONTRACT-021` | repository truth | `scripts/validate_static.py:808` | 0 |
| `STATIC-COST-001` | repository truth | `scripts/validate_static.py:1143` | 0 |
| `STATIC-COST-002` | repository truth | `scripts/validate_static.py:1146` | 0 |
| `STATIC-COST-003` | repository truth | `scripts/validate_static.py:1152` | 0 |
| `STATIC-COST-004` | repository truth | `scripts/validate_static.py:1154` | 0 |
| `STATIC-COST-005` | repository truth | `scripts/validate_static.py:1156` | 0 |
| `STATIC-DATA-001` | repository truth | `scripts/validate_static.py:162` | 0 |
| `STATIC-DB-001` | repository truth | `scripts/validate_static.py:1177` | 0 |
| `STATIC-GRAPH-001` | repository truth | `scripts/validate_static.py:1028` | 0 |
| `STATIC-HTTP-001` | repository truth | `scripts/validate_static.py:1159` | 0 |
| `STATIC-HTTP-002` | repository truth | `scripts/validate_static.py:1171` | 0 |
| `STATIC-MEASURE-001` | repository truth | `scripts/validate_static.py:333` | 0 |
| `STATIC-MEASURE-002` | repository truth | `scripts/test/repository_truth.py:386` | 1 |
| `STATIC-MEASURE-003` | repository truth | `scripts/validate_static.py:398` | 0 |
| `STATIC-MEASURE-004` | repository truth | `scripts/test/repository_truth.py:393` | 1 |
| `STATIC-MEASURE-005` | repository truth | `scripts/test/repository_truth.py:409` | 1 |
| `STATIC-PLACEHOLDER-001` | repository truth | `scripts/validate_static.py:1236` | 0 |
| `STATIC-PLAN-000` | repository truth | `scripts/validate_static.py:1124` | 0 |
| `STATIC-PLAN-001` | repository truth | `scripts/validate_static.py:1130` | 0 |
| `STATIC-PLAN-002` | repository truth | `scripts/validate_static.py:1137` | 0 |
| `STATIC-PLAN-003` | repository truth | `scripts/validate_static.py:1140` | 0 |
| `STATIC-PLUGIN-001` | repository truth | `scripts/validate_static.py:948` | 0 |
| `STATIC-PLUGIN-002` | repository truth | `scripts/validate_static.py:950` | 0 |
| `STATIC-PLUGIN-003` | repository truth | `scripts/validate_static.py:955` | 0 |
| `STATIC-PLUGIN-004` | repository truth | `scripts/validate_static.py:961` | 0 |
| `STATIC-PLUGIN-005` | repository truth | `scripts/validate_static.py:964` | 0 |
| `STATIC-PYTHON-001` | repository truth | `scripts/validate_static.py:1094` | 0 |
| `STATIC-QUALITY-001` | repository truth | `scripts/validate_static.py:1050` | 0 |
| `STATIC-QUALITY-002` | repository truth | `scripts/validate_static.py:1052` | 0 |
| `STATIC-QUALITY-003` | repository truth | `scripts/validate_static.py:1056` | 0 |
| `STATIC-QUALITY-004` | repository truth | `scripts/validate_static.py:1069` | 0 |
| `STATIC-ROADMAP-001` | repository truth | `scripts/validate_static.py:979` | 0 |
| `STATIC-ROADMAP-002` | repository truth | `scripts/validate_static.py:983` | 0 |
| `STATIC-RUST-001` | repository truth | `scripts/validate_static.py:1082` | 0 |
| `STATIC-SAM-001` | repository truth | `scripts/validate_static.py:1189` | 0 |
| `STATIC-SAM-002` | repository truth | `scripts/validate_static.py:1207` | 0 |
| `STATIC-SAM-003` | repository truth | `scripts/validate_static.py:1210` | 0 |
| `STATIC-SAM-004` | repository truth | `scripts/validate_static.py:1214` | 0 |
| `STATIC-SAM-005` | repository truth | `scripts/validate_static.py:1201` | 0 |
| `STATIC-SHELL-001` | repository truth | `scripts/validate_static.py:1105` | 0 |
| `STATIC-SHELL-002` | repository truth | `scripts/validate_static.py:1107` | 0 |
| `STATIC-TASK-001` | repository truth | `scripts/validate_static.py:988` | 0 |
| `STATIC-TASK-002` | repository truth | `scripts/validate_static.py:994` | 0 |
| `STATIC-TASK-003` | repository truth | `scripts/validate_static.py:998` | 0 |
| `STATIC-TASK-004` | repository truth | `scripts/validate_static.py:1001` | 0 |
| `STATIC-TASK-005` | repository truth | `scripts/validate_static.py:1005` | 0 |
| `STATIC-TASK-006` | repository truth | `scripts/validate_static.py:1007` | 0 |
| `STATIC-TASK-007` | repository truth | `scripts/validate_static.py:1010` | 0 |
| `STATIC-TASK-008` | repository truth | `scripts/validate_static.py:1012` | 0 |
| `STATIC-TASK-009` | repository truth | `scripts/validate_static.py:1016` | 0 |
| `STATIC-TRUTH-ADOPTION-001` | repository truth | `scripts/validate_static.py:673` | 0 |
...
| `STATIC-TRUTH-PLAN-001` | repository truth | `scripts/validate_static.py:685` | 0 |
| `STATIC-TRUTH-PLAN-002` | repository truth | `scripts/validate_static.py:691` | 0 |
...
| `STATIC-TRUTH-ROADMAP-002` | repository truth | `scripts/validate_static.py:666` | 0 |
