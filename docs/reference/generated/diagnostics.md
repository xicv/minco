...
| `ASSURANCE-DATE-001` | deployment assurance | `scripts/quality_assurance.py:1107` | 1 |
...
| `ASSURANCE-PATH-001` | deployment assurance | `scripts/quality_assurance.py:1206` | 9 |
| `ASSURANCE-PATH-002` | deployment assurance | `scripts/quality_assurance.py:839` | 2 |
| `ASSURANCE-PATH-003` | deployment assurance | `scripts/quality_assurance.py:1171` | 0 |
...
| `ASSURANCE-PERFORMANCE-001` | deployment assurance | `scripts/quality_assurance.py:1054` | 1 |
...
| `ASSURANCE-SEMVER-002` | deployment assurance | `scripts/quality_assurance.py:967` | 0 |
...
| `MINCO-AUDIT-CONFLICT` | audit | `plugins/minco-plugin-audit/src/lib.rs:352` | 0 |
| `MINCO-AUTH-001` | auth | `crates/minco-plan/src/model.rs:585` | 0 |
| `MINCO-AWS-001` | aws | `crates/minco-plan/src/model.rs:1358` | 1 |
| `MINCO-AWS-002` | aws | `crates/minco-plan/src/model.rs:1374` | 1 |
...
| `MINCO-COST-001` | cost | `crates/minco-plan/src/model.rs:686` | 0 |
| `MINCO-COST-002` | cost | `crates/minco-plan/src/model.rs:700` | 1 |
| `MINCO-COST-003` | cost | `crates/minco-plan/src/model.rs:766` | 0 |
| `MINCO-COST-004` | cost | `crates/minco-plan/src/model.rs:772` | 0 |
| `MINCO-COST-005` | cost | `crates/minco-plan/src/model.rs:817` | 1 |
| `MINCO-COST-006` | cost | `crates/minco-plan/src/model.rs:680` | 0 |
| `MINCO-COST-007` | cost | `crates/minco-plan/src/model.rs:2681` | 1 |
| `MINCO-COST-008` | cost | `crates/minco-plan/src/model.rs:2710` | 1 |
| `MINCO-COST-009` | cost | `crates/minco-plan/src/model.rs:721` | 2 |
| `MINCO-COST-010` | cost | `crates/minco-plan/src/model.rs:756` | 0 |
| `MINCO-DB-001` | db | `crates/minco-plan/src/model.rs:829` | 0 |
| `MINCO-DB-002` | db | `crates/minco-plan/src/model.rs:835` | 0 |
| `MINCO-DB-003` | db | `crates/minco-plan/src/model.rs:854` | 0 |
| `MINCO-DB-004` | db | `crates/minco-plan/src/model.rs:2753` | 2 |
| `MINCO-DB-005` | db | `crates/minco-plan/src/model.rs:870` | 0 |
| `MINCO-DYNAMODB-001` | dynamodb | `crates/minco-plan/src/model.rs:1466` | 0 |
| `MINCO-DYNAMODB-002` | dynamodb | `crates/minco-plan/src/model.rs:1472` | 1 |
| `MINCO-DYNAMODB-003` | dynamodb | `crates/minco-plan/src/model.rs:1482` | 1 |
| `MINCO-DYNAMODB-004` | dynamodb | `crates/minco-plan/src/model.rs:1488` | 0 |
| `MINCO-DYNAMODB-005` | dynamodb | `crates/minco-plan/src/model.rs:1537` | 0 |
| `MINCO-DYNAMODB-006` | dynamodb | `crates/minco-plan/src/model.rs:1546` | 0 |
| `MINCO-DYNAMODB-007` | dynamodb | `crates/minco-plan/src/model.rs:1498` | 1 |
| `MINCO-DYNAMODB-008` | dynamodb | `crates/minco-plan/src/model.rs:1509` | 1 |
| `MINCO-DYNAMODB-009` | dynamodb | `crates/minco-plan/src/model.rs:1428` | 0 |
| `MINCO-DYNAMODB-010` | dynamodb | `crates/minco-plan/src/model.rs:1434` | 0 |
| `MINCO-DYNAMODB-011` | dynamodb | `crates/minco-plan/src/model.rs:1447` | 0 |
| `MINCO-DYNAMODB-012` | dynamodb | `crates/minco-plan/src/model.rs:1453` | 0 |
| `MINCO-DYNAMODB-013` | dynamodb | `crates/minco-plan/src/model.rs:1415` | 0 |
...
| `MINCO-HTTP-001` | http | `crates/minco-plan/src/model.rs:638` | 0 |
| `MINCO-HTTP-002` | http | `crates/minco-plan/src/model.rs:643` | 0 |
| `MINCO-HTTP-003` | http | `crates/minco-plan/src/model.rs:647` | 0 |
| `MINCO-HTTP-004` | http | `crates/minco-plan/src/model.rs:655` | 0 |
| `MINCO-HTTP-005` | http | `crates/minco-plan/src/model.rs:662` | 0 |
| `MINCO-HTTP-006` | http | `crates/minco-plan/src/model.rs:667` | 0 |
| `MINCO-HTTP-007` | http | `crates/minco-plan/src/model.rs:674` | 0 |
| `MINCO-IAM-001` | iam | `crates/minco-plan/src/model.rs:631` | 1 |
...
| `MINCO-MAIL-004` | mail | `crates/minco-plan/src/inbound_mail.rs:23` | 1 |
...
| `MINCO-MAIL-012` | mail | `crates/minco-plan/src/inbound_mail.rs:31` | 0 |
| `MINCO-MAIL-013` | mail | `crates/minco-plan/src/inbound_mail.rs:32` | 0 |
| `MINCO-MAIL-014` | mail | `crates/minco-plan/src/inbound_mail.rs:35` | 4 |
| `MINCO-MAIL-015` | mail | `crates/minco-plan/src/inbound_mail.rs:38` | 1 |
...
| `MINCO-PERF-004` | perf | `crates/minco-plan/src/model.rs:747` | 0 |
| `MINCO-PLAN-001` | plan | `crates/minco-plan/src/model.rs:472` | 0 |
| `MINCO-PLAN-002` | plan | `crates/minco-plan/src/model.rs:590` | 0 |
| `MINCO-PLAN-003` | plan | `crates/minco-plan/src/model.rs:2596` | 1 |
| `MINCO-PLAN-004` | plan | `crates/minco-plan/src/model.rs:597` | 0 |
| `MINCO-PLAN-005` | plan | `crates/minco-plan/src/model.rs:607` | 1 |
| `MINCO-PLAN-010` | plan | `crates/minco-plan/src/model.rs:1031` | 2 |
| `MINCO-PLAN-011` | plan | `crates/minco-plan/src/model.rs:919` | 1 |
| `MINCO-PLAN-012` | plan | `crates/minco-plan/src/model.rs:931` | 0 |
| `MINCO-PLAN-013` | plan | `crates/minco-plan/src/model.rs:946` | 1 |
| `MINCO-PLAN-014` | plan | `crates/minco-plan/src/model.rs:1037` | 1 |
| `MINCO-PLAN-015` | plan | `crates/minco-plan/src/model.rs:1054` | 5 |
| `MINCO-PLAN-016` | plan | `crates/minco-plan/src/model.rs:1047` | 2 |
| `MINCO-PLAN-017` | plan | `crates/minco-plan/src/model.rs:1259` | 0 |
| `MINCO-PLAN-018` | plan | `crates/minco-plan/src/model.rs:1274` | 4 |
| `MINCO-PLAN-INGRESS-001` | plan | `crates/minco-plan/src/model.rs:2624` | 3 |
| `MINCO-PLAN-INGRESS-002` | plan | `crates/minco-plan/src/model.rs:2652` | 5 |
| `MINCO-PLAN-MIGRATE-001` | plan | `crates/minco-plan/src/model.rs:429` | 1 |
| `MINCO-PLAN-MIGRATE-002` | plan | `crates/minco-plan/src/model.rs:436` | 2 |
| `MINCO-PLAN-MIGRATE-003` | plan | `crates/minco-plan/src/model.rs:462` | 0 |
| `MINCO-PREVIEW-001` | preview | `crates/minco-plan/src/model.rs:540` | 0 |
| `MINCO-PREVIEW-002` | preview | `crates/minco-plan/src/model.rs:546` | 0 |
| `MINCO-PREVIEW-003` | preview | `crates/minco-plan/src/model.rs:564` | 1 |
| `MINCO-PREVIEW-004` | preview | `crates/minco-plan/src/model.rs:570` | 0 |
| `MINCO-PREVIEW-006` | preview | `crates/minco-plan/src/model.rs:577` | 1 |
| `MINCO-REALTIME-001` | realtime | `crates/minco-plan/src/model.rs:502` | 0 |
| `MINCO-REALTIME-002` | realtime | `crates/minco-plan/src/model.rs:508` | 0 |
| `MINCO-SCHEDULE-001` | schedule | `crates/minco-plan/src/model.rs:1175` | 1 |
| `MINCO-SCHEDULE-002` | schedule | `crates/minco-plan/src/model.rs:1181` | 1 |
| `MINCO-SCHEDULE-003` | schedule | `crates/minco-plan/src/model.rs:615` | 1 |
| `MINCO-SCHEDULE-004` | schedule | `crates/minco-plan/src/model.rs:1192` | 1 |
| `MINCO-SCHEDULE-005` | schedule | `crates/minco-plan/src/model.rs:1207` | 0 |
| `MINCO-SCHEDULE-006` | schedule | `crates/minco-plan/src/model.rs:1216` | 0 |
| `MINCO-SQS-001` | sqs | `crates/minco-plan/src/model.rs:1149` | 1 |
| `MINCO-SQS-002` | sqs | `crates/minco-plan/src/model.rs:1103` | 1 |
| `MINCO-SQS-003` | sqs | `crates/minco-plan/src/model.rs:981` | 1 |
| `MINCO-SQS-004` | sqs | `crates/minco-plan/src/model.rs:1011` | 1 |
| `MINCO-SQS-005` | sqs | `crates/minco-plan/src/model.rs:1001` | 0 |
| `MINCO-SQS-006` | sqs | `crates/minco-plan/src/model.rs:1021` | 1 |
| `MINCO-SQS-007` | sqs | `crates/minco-plan/src/model.rs:1116` | 1 |
| `MINCO-SQS-008` | sqs | `crates/minco-plan/src/model.rs:1127` | 1 |
| `MINCO-SQS-009` | sqs | `crates/minco-plan/src/model.rs:1139` | 0 |
| `MINCO-SQS-010` | sqs | `crates/minco-plan/src/model.rs:952` | 0 |
| `MINCO-SQS-011` | sqs | `crates/minco-plan/src/model.rs:961` | 0 |
| `MINCO-SQS-012` | sqs | `crates/minco-plan/src/model.rs:1249` | 1 |
| `MINCO-STATIC-001` | static | `crates/minco-plan/src/model.rs:495` | 0 |
