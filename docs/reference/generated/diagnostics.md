...
| `STATIC-ARCH-001` | repository truth | `scripts/validate_static.py:1007` | 0 |
| `STATIC-ARCH-002` | repository truth | `scripts/validate_static.py:1013` | 0 |
| `STATIC-ARCH-003` | repository truth | `scripts/validate_static.py:1019` | 0 |
| `STATIC-ARCH-004` | repository truth | `scripts/validate_static.py:1022` | 0 |
| `STATIC-BUDGET-001` | repository truth | `scripts/validate_static.py:702` | 0 |
| `STATIC-BUDGET-002` | repository truth | `scripts/validate_static.py:480` | 0 |
| `STATIC-BUDGET-003` | repository truth | `scripts/validate_static.py:337` | 0 |
| `STATIC-BUDGET-004` | repository truth | `scripts/test/repository_truth.py:472` | 3 |
| `STATIC-BUDGET-005` | repository truth | `scripts/validate_static.py:443` | 0 |
| `STATIC-BUDGET-006` | repository truth | `scripts/test/repository_truth.py:545` | 1 |
| `STATIC-BUDGET-007` | repository truth | `scripts/test/repository_truth.py:562` | 1 |
...
| `STATIC-CONTRACT-001` | repository truth | `scripts/validate_static.py:850` | 0 |
| `STATIC-CONTRACT-002` | repository truth | `scripts/validate_static.py:855` | 0 |
| `STATIC-CONTRACT-003` | repository truth | `scripts/validate_static.py:863` | 0 |
| `STATIC-CONTRACT-004` | repository truth | `scripts/validate_static.py:866` | 0 |
| `STATIC-CONTRACT-005` | repository truth | `scripts/validate_static.py:870` | 0 |
| `STATIC-CONTRACT-006` | repository truth | `scripts/validate_static.py:872` | 0 |
| `STATIC-CONTRACT-007` | repository truth | `scripts/validate_static.py:911` | 0 |
| `STATIC-CONTRACT-008` | repository truth | `scripts/validate_static.py:960` | 0 |
| `STATIC-CONTRACT-009` | repository truth | `scripts/validate_static.py:968` | 0 |
| `STATIC-CONTRACT-010` | repository truth | `scripts/validate_static.py:973` | 0 |
| `STATIC-CONTRACT-011` | repository truth | `scripts/validate_static.py:977` | 0 |
| `STATIC-CONTRACT-012` | repository truth | `scripts/validate_static.py:983` | 0 |
| `STATIC-CONTRACT-013` | repository truth | `scripts/validate_static.py:988` | 0 |
| `STATIC-CONTRACT-014` | repository truth | `scripts/validate_static.py:886` | 0 |
| `STATIC-CONTRACT-015` | repository truth | `scripts/validate_static.py:914` | 0 |
| `STATIC-CONTRACT-016` | repository truth | `scripts/validate_static.py:929` | 0 |
| `STATIC-CONTRACT-017` | repository truth | `scripts/validate_static.py:879` | 0 |
| `STATIC-CONTRACT-019` | repository truth | `scripts/validate_static.py:947` | 0 |
| `STATIC-CONTRACT-020` | repository truth | `scripts/validate_static.py:922` | 0 |
| `STATIC-CONTRACT-021` | repository truth | `scripts/validate_static.py:898` | 0 |
| `STATIC-COST-001` | repository truth | `scripts/validate_static.py:1233` | 0 |
| `STATIC-COST-002` | repository truth | `scripts/validate_static.py:1236` | 0 |
| `STATIC-COST-003` | repository truth | `scripts/validate_static.py:1242` | 0 |
| `STATIC-COST-004` | repository truth | `scripts/validate_static.py:1244` | 0 |
| `STATIC-COST-005` | repository truth | `scripts/validate_static.py:1246` | 0 |
| `STATIC-DATA-001` | repository truth | `scripts/validate_static.py:162` | 0 |
| `STATIC-DB-001` | repository truth | `scripts/validate_static.py:1267` | 0 |
| `STATIC-GRAPH-001` | repository truth | `scripts/validate_static.py:1118` | 0 |
| `STATIC-HTTP-001` | repository truth | `scripts/validate_static.py:1249` | 0 |
| `STATIC-HTTP-002` | repository truth | `scripts/validate_static.py:1261` | 0 |
| `STATIC-MEASURE-001` | repository truth | `scripts/validate_static.py:358` | 0 |
| `STATIC-MEASURE-002` | repository truth | `scripts/test/repository_truth.py:503` | 1 |
| `STATIC-MEASURE-003` | repository truth | `scripts/validate_static.py:455` | 0 |
| `STATIC-MEASURE-004` | repository truth | `scripts/test/repository_truth.py:510` | 1 |
| `STATIC-MEASURE-005` | repository truth | `scripts/test/repository_truth.py:552` | 1 |
| `STATIC-PLACEHOLDER-001` | repository truth | `scripts/validate_static.py:1326` | 0 |
| `STATIC-PLAN-000` | repository truth | `scripts/validate_static.py:1214` | 0 |
| `STATIC-PLAN-001` | repository truth | `scripts/validate_static.py:1220` | 0 |
| `STATIC-PLAN-002` | repository truth | `scripts/validate_static.py:1227` | 0 |
| `STATIC-PLAN-003` | repository truth | `scripts/validate_static.py:1230` | 0 |
| `STATIC-PLUGIN-001` | repository truth | `scripts/validate_static.py:1038` | 0 |
| `STATIC-PLUGIN-002` | repository truth | `scripts/validate_static.py:1040` | 0 |
| `STATIC-PLUGIN-003` | repository truth | `scripts/validate_static.py:1045` | 0 |
| `STATIC-PLUGIN-004` | repository truth | `scripts/validate_static.py:1051` | 0 |
| `STATIC-PLUGIN-005` | repository truth | `scripts/validate_static.py:1054` | 0 |
| `STATIC-PYTHON-001` | repository truth | `scripts/validate_static.py:1184` | 0 |
| `STATIC-QUALITY-001` | repository truth | `scripts/validate_static.py:1140` | 0 |
| `STATIC-QUALITY-002` | repository truth | `scripts/validate_static.py:1142` | 0 |
| `STATIC-QUALITY-003` | repository truth | `scripts/validate_static.py:1146` | 0 |
| `STATIC-QUALITY-004` | repository truth | `scripts/validate_static.py:1159` | 0 |
| `STATIC-ROADMAP-001` | repository truth | `scripts/validate_static.py:1069` | 0 |
| `STATIC-ROADMAP-002` | repository truth | `scripts/validate_static.py:1073` | 0 |
| `STATIC-RUST-001` | repository truth | `scripts/validate_static.py:1172` | 0 |
| `STATIC-SAM-001` | repository truth | `scripts/validate_static.py:1279` | 0 |
| `STATIC-SAM-002` | repository truth | `scripts/validate_static.py:1297` | 0 |
| `STATIC-SAM-003` | repository truth | `scripts/validate_static.py:1300` | 0 |
| `STATIC-SAM-004` | repository truth | `scripts/validate_static.py:1304` | 0 |
| `STATIC-SAM-005` | repository truth | `scripts/validate_static.py:1291` | 0 |
| `STATIC-SHELL-001` | repository truth | `scripts/validate_static.py:1195` | 0 |
| `STATIC-SHELL-002` | repository truth | `scripts/validate_static.py:1197` | 0 |
| `STATIC-TASK-001` | repository truth | `scripts/validate_static.py:1078` | 0 |
| `STATIC-TASK-002` | repository truth | `scripts/validate_static.py:1084` | 0 |
| `STATIC-TASK-003` | repository truth | `scripts/validate_static.py:1088` | 0 |
| `STATIC-TASK-004` | repository truth | `scripts/validate_static.py:1091` | 0 |
| `STATIC-TASK-005` | repository truth | `scripts/validate_static.py:1095` | 0 |
| `STATIC-TASK-006` | repository truth | `scripts/validate_static.py:1097` | 0 |
| `STATIC-TASK-007` | repository truth | `scripts/validate_static.py:1100` | 0 |
| `STATIC-TASK-008` | repository truth | `scripts/validate_static.py:1102` | 0 |
| `STATIC-TASK-009` | repository truth | `scripts/validate_static.py:1106` | 0 |
| `STATIC-TRUTH-ADOPTION-001` | repository truth | `scripts/validate_static.py:757` | 0 |
| `STATIC-TRUTH-CATALOG-001` | repository truth | `scripts/validate_static.py:601` | 0 |
| `STATIC-TRUTH-CATALOG-002` | repository truth | `scripts/test/repository_truth.py:425` | 1 |
| `STATIC-TRUTH-CATALOG-003` | repository truth | `scripts/validate_static.py:588` | 0 |
| `STATIC-TRUTH-CATALOG-004` | repository truth | `scripts/validate_static.py:590` | 0 |
| `STATIC-TRUTH-CATALOG-005` | repository truth | `scripts/validate_static.py:592` | 0 |
| `STATIC-TRUTH-CATALOG-006` | repository truth | `scripts/validate_static.py:659` | 0 |
| `STATIC-TRUTH-DESCRIPTOR-001` | repository truth | `scripts/validate_static.py:631` | 0 |
| `STATIC-TRUTH-DESCRIPTOR-002` | repository truth | `scripts/validate_static.py:637` | 0 |
| `STATIC-TRUTH-DESCRIPTOR-003` | repository truth | `scripts/validate_static.py:644` | 0 |
| `STATIC-TRUTH-DOCS-001` | repository truth | `scripts/test/current_product_truth.py:64` | 6 |
| `STATIC-TRUTH-DOCS-002` | repository truth | `scripts/test/repository_truth.py:166` | 1 |
| `STATIC-TRUTH-FACADE-001` | repository truth | `scripts/validate_static.py:613` | 0 |
| `STATIC-TRUTH-FACADE-002` | repository truth | `scripts/validate_static.py:619` | 0 |
| `STATIC-TRUTH-FACADE-003` | repository truth | `scripts/validate_static.py:676` | 0 |
| `STATIC-TRUTH-FACADE-004` | repository truth | `scripts/validate_static.py:690` | 0 |
| `STATIC-TRUTH-PACKAGES-001` | repository truth | `scripts/validate_static.py:509` | 0 |
| `STATIC-TRUTH-PACKAGES-002` | repository truth | `scripts/validate_static.py:515` | 0 |
| `STATIC-TRUTH-PACKAGES-003` | repository truth | `scripts/test/repository_truth.py:393` | 2 |
| `STATIC-TRUTH-PACKAGES-004` | repository truth | `scripts/test/repository_truth.py:383` | 1 |
| `STATIC-TRUTH-PLAN-001` | repository truth | `scripts/validate_static.py:769` | 0 |
| `STATIC-TRUTH-PLAN-002` | repository truth | `scripts/validate_static.py:775` | 0 |
| `STATIC-TRUTH-PUBLISHED-001` | repository truth | `scripts/validate_static.py:233` | 0 |
| `STATIC-TRUTH-PUBLISHED-002` | repository truth | `scripts/test/repository_truth.py:404` | 2 |
| `STATIC-TRUTH-PUBLISHED-003` | repository truth | `scripts/test/repository_truth.py:415` | 1 |
| `STATIC-TRUTH-RELEASE-001` | repository truth | `scripts/test/repository_truth.py:308` | 1 |
| `STATIC-TRUTH-RELEASE-002` | repository truth | `scripts/test/repository_truth.py:318` | 1 |
| `STATIC-TRUTH-RELEASE-003` | repository truth | `scripts/test/repository_truth.py:328` | 1 |
| `STATIC-TRUTH-RELEASE-004` | repository truth | `scripts/validate_static.py:280` | 0 |
| `STATIC-TRUTH-RELEASE-005` | repository truth | `scripts/test/current_product_truth.py:88` | 1 |
| `STATIC-TRUTH-ROADMAP-001` | repository truth | `scripts/test/repository_truth.py:436` | 1 |
| `STATIC-TRUTH-ROADMAP-002` | repository truth | `scripts/test/repository_truth.py:465` | 1 |
| `STATIC-TRUTH-ROADMAP-003` | repository truth | `scripts/test/repository_truth.py:446` | 1 |
| `STATIC-TRUTH-VERSION-001` | repository truth | `scripts/test/repository_truth.py:297` | 1 |
