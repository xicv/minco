...
| `MINCO-AUTH-001` | auth | `crates/minco-plan/src/model.rs:566` | 0 |
| `MINCO-AWS-001` | aws | `crates/minco-plan/src/model.rs:1339` | 1 |
| `MINCO-AWS-002` | aws | `crates/minco-plan/src/model.rs:1355` | 1 |
...
| `MINCO-COST-001` | cost | `crates/minco-plan/src/model.rs:667` | 0 |
| `MINCO-COST-002` | cost | `crates/minco-plan/src/model.rs:681` | 1 |
| `MINCO-COST-003` | cost | `crates/minco-plan/src/model.rs:747` | 0 |
| `MINCO-COST-004` | cost | `crates/minco-plan/src/model.rs:753` | 0 |
| `MINCO-COST-005` | cost | `crates/minco-plan/src/model.rs:798` | 1 |
| `MINCO-COST-006` | cost | `crates/minco-plan/src/model.rs:661` | 0 |
| `MINCO-COST-007` | cost | `crates/minco-plan/src/model.rs:2662` | 1 |
| `MINCO-COST-008` | cost | `crates/minco-plan/src/model.rs:2691` | 1 |
| `MINCO-COST-009` | cost | `crates/minco-plan/src/model.rs:702` | 2 |
| `MINCO-COST-010` | cost | `crates/minco-plan/src/model.rs:737` | 0 |
| `MINCO-DB-001` | db | `crates/minco-plan/src/model.rs:810` | 0 |
| `MINCO-DB-002` | db | `crates/minco-plan/src/model.rs:816` | 0 |
| `MINCO-DB-003` | db | `crates/minco-plan/src/model.rs:835` | 0 |
| `MINCO-DB-004` | db | `crates/minco-plan/src/model.rs:2734` | 2 |
| `MINCO-DB-005` | db | `crates/minco-plan/src/model.rs:851` | 0 |
| `MINCO-DYNAMODB-001` | dynamodb | `crates/minco-plan/src/model.rs:1447` | 0 |
| `MINCO-DYNAMODB-002` | dynamodb | `crates/minco-plan/src/model.rs:1453` | 1 |
| `MINCO-DYNAMODB-003` | dynamodb | `crates/minco-plan/src/model.rs:1463` | 1 |
| `MINCO-DYNAMODB-004` | dynamodb | `crates/minco-plan/src/model.rs:1469` | 0 |
| `MINCO-DYNAMODB-005` | dynamodb | `crates/minco-plan/src/model.rs:1518` | 0 |
| `MINCO-DYNAMODB-006` | dynamodb | `crates/minco-plan/src/model.rs:1527` | 0 |
| `MINCO-DYNAMODB-007` | dynamodb | `crates/minco-plan/src/model.rs:1479` | 1 |
| `MINCO-DYNAMODB-008` | dynamodb | `crates/minco-plan/src/model.rs:1490` | 1 |
| `MINCO-DYNAMODB-009` | dynamodb | `crates/minco-plan/src/model.rs:1409` | 0 |
| `MINCO-DYNAMODB-010` | dynamodb | `crates/minco-plan/src/model.rs:1415` | 0 |
| `MINCO-DYNAMODB-011` | dynamodb | `crates/minco-plan/src/model.rs:1428` | 0 |
| `MINCO-DYNAMODB-012` | dynamodb | `crates/minco-plan/src/model.rs:1434` | 0 |
| `MINCO-DYNAMODB-013` | dynamodb | `crates/minco-plan/src/model.rs:1396` | 0 |
...
| `MINCO-HTTP-001` | http | `crates/minco-plan/src/model.rs:619` | 0 |
| `MINCO-HTTP-002` | http | `crates/minco-plan/src/model.rs:624` | 0 |
| `MINCO-HTTP-003` | http | `crates/minco-plan/src/model.rs:628` | 0 |
| `MINCO-HTTP-004` | http | `crates/minco-plan/src/model.rs:636` | 0 |
| `MINCO-HTTP-005` | http | `crates/minco-plan/src/model.rs:643` | 0 |
| `MINCO-HTTP-006` | http | `crates/minco-plan/src/model.rs:648` | 0 |
| `MINCO-HTTP-007` | http | `crates/minco-plan/src/model.rs:655` | 0 |
| `MINCO-IAM-001` | iam | `crates/minco-plan/src/model.rs:612` | 1 |
...
| `MINCO-PERF-001` | perf | `crates/minco-plan/src/model.rs:764` | 0 |
| `MINCO-PERF-002` | perf | `crates/minco-plan/src/model.rs:775` | 0 |
| `MINCO-PERF-003` | perf | `crates/minco-cli/src/main.rs:5549` | 0 |
| `MINCO-PERF-004` | perf | `crates/minco-plan/src/model.rs:728` | 0 |
| `MINCO-PLAN-001` | plan | `crates/minco-plan/src/model.rs:453` | 0 |
| `MINCO-PLAN-002` | plan | `crates/minco-plan/src/model.rs:571` | 0 |
| `MINCO-PLAN-003` | plan | `crates/minco-plan/src/model.rs:2577` | 1 |
| `MINCO-PLAN-004` | plan | `crates/minco-plan/src/model.rs:578` | 0 |
| `MINCO-PLAN-005` | plan | `crates/minco-plan/src/model.rs:588` | 1 |
| `MINCO-PLAN-010` | plan | `crates/minco-plan/src/model.rs:1012` | 2 |
| `MINCO-PLAN-011` | plan | `crates/minco-plan/src/model.rs:900` | 1 |
| `MINCO-PLAN-012` | plan | `crates/minco-plan/src/model.rs:912` | 0 |
| `MINCO-PLAN-013` | plan | `crates/minco-plan/src/model.rs:927` | 1 |
| `MINCO-PLAN-014` | plan | `crates/minco-plan/src/model.rs:1018` | 1 |
| `MINCO-PLAN-015` | plan | `crates/minco-plan/src/model.rs:1035` | 5 |
| `MINCO-PLAN-016` | plan | `crates/minco-plan/src/model.rs:1028` | 2 |
| `MINCO-PLAN-017` | plan | `crates/minco-plan/src/model.rs:1240` | 0 |
| `MINCO-PLAN-018` | plan | `crates/minco-plan/src/model.rs:1255` | 4 |
| `MINCO-PLAN-INGRESS-001` | plan | `crates/minco-plan/src/model.rs:2605` | 3 |
| `MINCO-PLAN-INGRESS-002` | plan | `crates/minco-plan/src/model.rs:2633` | 5 |
| `MINCO-PLAN-MIGRATE-001` | plan | `crates/minco-plan/src/model.rs:410` | 1 |
| `MINCO-PLAN-MIGRATE-002` | plan | `crates/minco-plan/src/model.rs:417` | 2 |
| `MINCO-PLAN-MIGRATE-003` | plan | `crates/minco-plan/src/model.rs:443` | 0 |
| `MINCO-PREVIEW-001` | preview | `crates/minco-plan/src/model.rs:521` | 0 |
| `MINCO-PREVIEW-002` | preview | `crates/minco-plan/src/model.rs:527` | 0 |
| `MINCO-PREVIEW-003` | preview | `crates/minco-plan/src/model.rs:545` | 1 |
| `MINCO-PREVIEW-004` | preview | `crates/minco-plan/src/model.rs:551` | 0 |
| `MINCO-PREVIEW-006` | preview | `crates/minco-plan/src/model.rs:558` | 1 |
| `MINCO-REALTIME-001` | realtime | `crates/minco-plan/src/model.rs:483` | 0 |
| `MINCO-REALTIME-002` | realtime | `crates/minco-plan/src/model.rs:489` | 0 |
| `MINCO-SCHEDULE-001` | schedule | `crates/minco-plan/src/model.rs:1156` | 1 |
| `MINCO-SCHEDULE-002` | schedule | `crates/minco-plan/src/model.rs:1162` | 1 |
| `MINCO-SCHEDULE-003` | schedule | `crates/minco-plan/src/model.rs:596` | 1 |
| `MINCO-SCHEDULE-004` | schedule | `crates/minco-plan/src/model.rs:1173` | 1 |
| `MINCO-SCHEDULE-005` | schedule | `crates/minco-plan/src/model.rs:1188` | 0 |
| `MINCO-SCHEDULE-006` | schedule | `crates/minco-plan/src/model.rs:1197` | 0 |
| `MINCO-SQS-001` | sqs | `crates/minco-plan/src/model.rs:1130` | 1 |
| `MINCO-SQS-002` | sqs | `crates/minco-plan/src/model.rs:1084` | 1 |
| `MINCO-SQS-003` | sqs | `crates/minco-plan/src/model.rs:962` | 1 |
| `MINCO-SQS-004` | sqs | `crates/minco-plan/src/model.rs:955` | 1 |
| `MINCO-SQS-005` | sqs | `crates/minco-plan/src/model.rs:982` | 0 |
| `MINCO-SQS-006` | sqs | `crates/minco-plan/src/model.rs:1002` | 1 |
| `MINCO-SQS-007` | sqs | `crates/minco-plan/src/model.rs:1097` | 1 |
| `MINCO-SQS-008` | sqs | `crates/minco-plan/src/model.rs:1108` | 1 |
| `MINCO-SQS-009` | sqs | `crates/minco-plan/src/model.rs:1120` | 0 |
| `MINCO-SQS-010` | sqs | `crates/minco-plan/src/model.rs:933` | 0 |
| `MINCO-SQS-011` | sqs | `crates/minco-plan/src/model.rs:942` | 0 |
| `MINCO-SQS-012` | sqs | `crates/minco-plan/src/model.rs:1230` | 1 |
| `MINCO-STATIC-001` | static | `crates/minco-plan/src/model.rs:476` | 0 |
