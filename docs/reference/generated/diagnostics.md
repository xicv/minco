...
| `MINCO-AUTH-001` | auth | `crates/minco-plan/src/model.rs:567` | 0 |
| `MINCO-AWS-001` | aws | `crates/minco-plan/src/model.rs:1340` | 1 |
| `MINCO-AWS-002` | aws | `crates/minco-plan/src/model.rs:1356` | 1 |
...
| `MINCO-COST-001` | cost | `crates/minco-plan/src/model.rs:668` | 0 |
| `MINCO-COST-002` | cost | `crates/minco-plan/src/model.rs:682` | 1 |
| `MINCO-COST-003` | cost | `crates/minco-plan/src/model.rs:748` | 0 |
| `MINCO-COST-004` | cost | `crates/minco-plan/src/model.rs:754` | 0 |
| `MINCO-COST-005` | cost | `crates/minco-plan/src/model.rs:799` | 1 |
| `MINCO-COST-006` | cost | `crates/minco-plan/src/model.rs:662` | 0 |
| `MINCO-COST-007` | cost | `crates/minco-plan/src/model.rs:2634` | 1 |
| `MINCO-COST-008` | cost | `crates/minco-plan/src/model.rs:2663` | 1 |
| `MINCO-COST-009` | cost | `crates/minco-plan/src/model.rs:703` | 2 |
| `MINCO-COST-010` | cost | `crates/minco-plan/src/model.rs:738` | 0 |
| `MINCO-DB-001` | db | `crates/minco-plan/src/model.rs:811` | 0 |
| `MINCO-DB-002` | db | `crates/minco-plan/src/model.rs:817` | 0 |
| `MINCO-DB-003` | db | `crates/minco-plan/src/model.rs:836` | 0 |
| `MINCO-DB-004` | db | `crates/minco-plan/src/model.rs:2706` | 2 |
| `MINCO-DB-005` | db | `crates/minco-plan/src/model.rs:852` | 0 |
| `MINCO-DYNAMODB-001` | dynamodb | `crates/minco-plan/src/model.rs:1448` | 0 |
| `MINCO-DYNAMODB-002` | dynamodb | `crates/minco-plan/src/model.rs:1454` | 1 |
| `MINCO-DYNAMODB-003` | dynamodb | `crates/minco-plan/src/model.rs:1464` | 1 |
| `MINCO-DYNAMODB-004` | dynamodb | `crates/minco-plan/src/model.rs:1470` | 0 |
| `MINCO-DYNAMODB-005` | dynamodb | `crates/minco-plan/src/model.rs:1519` | 0 |
| `MINCO-DYNAMODB-006` | dynamodb | `crates/minco-plan/src/model.rs:1528` | 0 |
| `MINCO-DYNAMODB-007` | dynamodb | `crates/minco-plan/src/model.rs:1480` | 1 |
| `MINCO-DYNAMODB-008` | dynamodb | `crates/minco-plan/src/model.rs:1491` | 1 |
| `MINCO-DYNAMODB-009` | dynamodb | `crates/minco-plan/src/model.rs:1410` | 0 |
| `MINCO-DYNAMODB-010` | dynamodb | `crates/minco-plan/src/model.rs:1416` | 0 |
| `MINCO-DYNAMODB-011` | dynamodb | `crates/minco-plan/src/model.rs:1429` | 0 |
| `MINCO-DYNAMODB-012` | dynamodb | `crates/minco-plan/src/model.rs:1435` | 0 |
| `MINCO-DYNAMODB-013` | dynamodb | `crates/minco-plan/src/model.rs:1397` | 0 |
...
| `MINCO-HTTP-001` | http | `crates/minco-plan/src/model.rs:620` | 0 |
| `MINCO-HTTP-002` | http | `crates/minco-plan/src/model.rs:625` | 0 |
| `MINCO-HTTP-003` | http | `crates/minco-plan/src/model.rs:629` | 0 |
| `MINCO-HTTP-004` | http | `crates/minco-plan/src/model.rs:637` | 0 |
| `MINCO-HTTP-005` | http | `crates/minco-plan/src/model.rs:644` | 0 |
| `MINCO-HTTP-006` | http | `crates/minco-plan/src/model.rs:649` | 0 |
| `MINCO-HTTP-007` | http | `crates/minco-plan/src/model.rs:656` | 0 |
| `MINCO-IAM-001` | iam | `crates/minco-plan/src/model.rs:613` | 1 |
...
| `MINCO-PERF-001` | perf | `crates/minco-plan/src/model.rs:765` | 0 |
| `MINCO-PERF-002` | perf | `crates/minco-plan/src/model.rs:776` | 0 |
| `MINCO-PERF-003` | perf | `crates/minco-cli/src/main.rs:5549` | 0 |
| `MINCO-PERF-004` | perf | `crates/minco-plan/src/model.rs:729` | 0 |
| `MINCO-PLAN-001` | plan | `crates/minco-plan/src/model.rs:454` | 0 |
| `MINCO-PLAN-002` | plan | `crates/minco-plan/src/model.rs:572` | 0 |
| `MINCO-PLAN-003` | plan | `crates/minco-plan/src/model.rs:2549` | 1 |
| `MINCO-PLAN-004` | plan | `crates/minco-plan/src/model.rs:579` | 0 |
| `MINCO-PLAN-005` | plan | `crates/minco-plan/src/model.rs:589` | 1 |
| `MINCO-PLAN-010` | plan | `crates/minco-plan/src/model.rs:1013` | 2 |
| `MINCO-PLAN-011` | plan | `crates/minco-plan/src/model.rs:901` | 1 |
| `MINCO-PLAN-012` | plan | `crates/minco-plan/src/model.rs:913` | 0 |
| `MINCO-PLAN-013` | plan | `crates/minco-plan/src/model.rs:928` | 1 |
| `MINCO-PLAN-014` | plan | `crates/minco-plan/src/model.rs:1019` | 1 |
| `MINCO-PLAN-015` | plan | `crates/minco-plan/src/model.rs:1036` | 5 |
| `MINCO-PLAN-016` | plan | `crates/minco-plan/src/model.rs:1029` | 2 |
| `MINCO-PLAN-017` | plan | `crates/minco-plan/src/model.rs:1241` | 0 |
| `MINCO-PLAN-018` | plan | `crates/minco-plan/src/model.rs:1256` | 4 |
| `MINCO-PLAN-INGRESS-001` | plan | `crates/minco-plan/src/model.rs:2577` | 3 |
| `MINCO-PLAN-INGRESS-002` | plan | `crates/minco-plan/src/model.rs:2605` | 5 |
| `MINCO-PLAN-MIGRATE-001` | plan | `crates/minco-plan/src/model.rs:411` | 1 |
| `MINCO-PLAN-MIGRATE-002` | plan | `crates/minco-plan/src/model.rs:418` | 2 |
| `MINCO-PLAN-MIGRATE-003` | plan | `crates/minco-plan/src/model.rs:444` | 0 |
| `MINCO-PREVIEW-001` | preview | `crates/minco-plan/src/model.rs:522` | 0 |
| `MINCO-PREVIEW-002` | preview | `crates/minco-plan/src/model.rs:528` | 0 |
| `MINCO-PREVIEW-003` | preview | `crates/minco-plan/src/model.rs:546` | 1 |
| `MINCO-PREVIEW-004` | preview | `crates/minco-plan/src/model.rs:552` | 0 |
| `MINCO-PREVIEW-006` | preview | `crates/minco-plan/src/model.rs:559` | 1 |
| `MINCO-REALTIME-001` | realtime | `crates/minco-plan/src/model.rs:484` | 0 |
| `MINCO-REALTIME-002` | realtime | `crates/minco-plan/src/model.rs:490` | 0 |
| `MINCO-SCHEDULE-001` | schedule | `crates/minco-plan/src/model.rs:1157` | 1 |
| `MINCO-SCHEDULE-002` | schedule | `crates/minco-plan/src/model.rs:1163` | 1 |
| `MINCO-SCHEDULE-003` | schedule | `crates/minco-plan/src/model.rs:597` | 1 |
| `MINCO-SCHEDULE-004` | schedule | `crates/minco-plan/src/model.rs:1174` | 1 |
| `MINCO-SCHEDULE-005` | schedule | `crates/minco-plan/src/model.rs:1189` | 0 |
| `MINCO-SCHEDULE-006` | schedule | `crates/minco-plan/src/model.rs:1198` | 0 |
| `MINCO-SQS-001` | sqs | `crates/minco-plan/src/model.rs:1131` | 1 |
| `MINCO-SQS-002` | sqs | `crates/minco-plan/src/model.rs:1085` | 1 |
| `MINCO-SQS-003` | sqs | `crates/minco-plan/src/model.rs:963` | 1 |
| `MINCO-SQS-004` | sqs | `crates/minco-plan/src/model.rs:956` | 1 |
| `MINCO-SQS-005` | sqs | `crates/minco-plan/src/model.rs:983` | 0 |
| `MINCO-SQS-006` | sqs | `crates/minco-plan/src/model.rs:1003` | 1 |
| `MINCO-SQS-007` | sqs | `crates/minco-plan/src/model.rs:1098` | 1 |
| `MINCO-SQS-008` | sqs | `crates/minco-plan/src/model.rs:1109` | 1 |
| `MINCO-SQS-009` | sqs | `crates/minco-plan/src/model.rs:1121` | 0 |
| `MINCO-SQS-010` | sqs | `crates/minco-plan/src/model.rs:934` | 0 |
| `MINCO-SQS-011` | sqs | `crates/minco-plan/src/model.rs:943` | 0 |
| `MINCO-SQS-012` | sqs | `crates/minco-plan/src/model.rs:1231` | 1 |
| `MINCO-STATIC-001` | static | `crates/minco-plan/src/model.rs:477` | 0 |
