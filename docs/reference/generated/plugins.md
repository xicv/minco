...
| `ticketing` | `minco-plugin-ticketing` | `plugin` | `plugin-ticketing` | no | `beta` | Project-scoped support ticketing with atomic browser handoffs, conversation, and explicit SQLite persistence. | ["native"] | ["sqlite"] | [] | [] | `d0b7f30ad206` / `7d9af0b1f4c2` |
