...
Use exact published `1.9.0` dependencies for applications. Follow the
...
The [1.9.0-to-1.10.0 guide](1.9.0-to-1.10.0.md) describes the unpublished
Ticketing candidate and its two first-publication package boundaries.
...
Applications moving from the published `0.6.0` family to `1.0.0` must use the
...
Applications moving from `1.5.0` to the published `1.6.0` release must use the
