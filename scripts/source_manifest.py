...
EXCLUDED_RELATIVE = {
    ...
    Path("verification/1.5-candidate-load.json"),
    Path("verification/1.5-candidate-recovery.json"),
    Path("verification/1.5-candidate-release-gates.json"),
    Path("verification/1.5-performance-baseline.json"),
    Path("verification/1.6-candidate-load.json"),
    Path("verification/1.6-candidate-recovery.json"),
    Path("verification/1.6-candidate-release-gates.json"),
    Path("verification/1.6-performance-baseline.json"),
    Path("verification/1.7-candidate-load.json"),
    Path("verification/1.7-candidate-recovery.json"),
    Path("verification/1.7-candidate-release-gates.json"),
    Path("verification/1.7-performance-baseline.json"),
    Path("verification/1.8-candidate-load.json"),
    Path("verification/1.8-candidate-recovery.json"),
    Path("verification/1.8-candidate-release-gates.json"),
    Path("verification/1.8-performance-baseline.json"),
    Path("verification/1.9-performance-baseline.json"),
    Path("verification/1.10-candidate-load.json"),
    Path("verification/1.10-candidate-recovery.json"),
    Path("verification/1.10-candidate-release-gates.json"),
    Path("verification/1.11-candidate-load.json"),
    Path("verification/1.11-candidate-recovery.json"),
    Path("verification/1.11-candidate-release-gates.json"),
